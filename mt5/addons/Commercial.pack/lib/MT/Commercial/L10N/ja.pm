...
#
# $Id: ja.pm 116653 2009-12-14 09:56:08Z auno $
...
',
	...
	'Themes that are compatible with the Professional Website template set.' => 'プロフェッショナル ウェブサイト互換テーマ',
...
## addons/Commercial.pack/templates/professional/blog/recent_entries_expanded.mtml
...
## addons/Commercial.pack/templates/professional/website/recent_assets.mtml

## addons/Commercial.pack/templates/professional/website/recent_comments.mtml
...
## addons/Commercial.pack/tmpl/edit_field.tmpl
	...
	'_CF_BASENAME' => 'ベースネーム',
	'The basename must be unique within this installation of Movable Type.' => 'ベースネームは、Movable Type内で重複しない値を入力してください。',
	...
	'Template Tag' => 'テンプレートタグ',
	'Create a template tag for this Custom Field.' => 'このカスタムフィールドのテンプレートタグを作成',
