...
#
# $Id: v3.pm 4196 2009-09-04 07:46:50Z takayama $
...
BEGIN {
    ...
    %cms_map = (
        ...
        Comment => [ qw( trust_commenter_by_comment unapprove_item set_item_visible not_junk reply_preview do_reply map_comment_to_commenter handle_junk cfg_spam untrust_commenter build_comment_table trust_commenter approve_item list_commenter unban_commenter empty_junk build_junk_table cfg_registration dialog_post_comment untrust_commenter_by_comment build_commenter_table ban_commenter_by_comment save_commenter_perm ban_commenter unban_commenter_by_comment reply ) ], # _prepare_reply
        Common => [ qw( delete ) ],
