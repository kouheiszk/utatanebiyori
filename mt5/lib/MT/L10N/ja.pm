...
#
#
# $Id: ja.pm 5056 2009-11-16 06:07:03Z auno $
...
## tmpl/cms/cfg_feedback.tmpl
	...
	'Include \'nofollow\' in URLs' => 'URLのnofollow指定',
...
## tmpl/cms/cfg_prefs.tmpl
	...
	'Used to generate URLs (permalinks) for this blog\'s archived entries. Choose one of the archives type used in this blog\'s archive templates.' => 'ブログ記事にリンクするときのURLとして使われます。このブログで使われているアーカイブテンプレートの中から選択してください。',
...
## tmpl/cms/cfg_system_general.tmpl
	...
	'Turn on performance logging, which will report any system event that takes the number of seconds specified below.' => 'パフォーマンスログを有効にして、以下で設定した秒数より時間のかかる処理をログに記録します。',
	'Log Path' => 'ログパス',
...
## tmpl/cms/list_association.tmpl
	...
	'Assign Website Role to User' => 'ウェブサイトロールをユーザーに付与',
	'Assign Blog Role to User' => 'ブログロールをユーザーに付与',
	'Add a user to this blog' => 'このブログにユーザーを追加',
	'Grant website permission to a user' => 'ウェブサイト権限をユーザーに付与',
	'Grant blog permission to a user' => 'ブログ権限をユーザーに付与',
