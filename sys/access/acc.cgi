...
sub main {
	...
	$c->{COPYRIGHT2} = "アクセス解析<!--<a href=\"http://www.futomi.com/\" target=\"_blank\">$c->{COPYRIGHT1}</a>-->";
	$c->{COPYRIGHT3} = "<div class=\"right\"><a href=\"http://www.futomi.com/\" target=\"_blank\">Powered by futomi\'s CGI Cafe<!--$c->{COPYRIGHT1}--></a></div>";
	#
