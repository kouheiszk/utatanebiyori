...
#    としてください。
#--------------------------------------------------------------------
$c{MY_SITE_URLs} = ['http://utatanebiyori.uzusionet.com'];
...
#--------------------------------------------------------------------
$c{URL2PATH_FLAG} = 1;
$c{URL2PATH} = {'http://utatanebiyori.uzusionet.com/' => '/home/utatanebiyori/public_html/'};
...
#  としてください。
#--------------------------------------------------------------------
$c{DIRECTORYINDEX} = ['index.html', 'index.htm','index.cgi','index.php'];
...
#--------------------------------------------------------------------
$c{MANUAL_CGIURL} = 'http://utatanebiyori.uzusionet.com/sys/access/acc.cgi';
