...
class Criterion{
	 ...
	 * @param Column $column
	 * @param string $value
	 * @param string $agreement w*:前方一致 *w:後方一致 *:部分一致
	 * @return CriteriaPattern
	 */
	...
	function startswith($columnList,$wordList,$not=false){
		/*** unit("database.QTest");  */
		return Criterion::pattern($columnList,$wordList,$not,false,"w*");
	}
	 ...
	 * @return Criteria
	 */
	function notStartswith($columnList,$wordList){
		/*** unit("database.QTest");  */
		return Criterion::startswith($columnList,$wordList,true);
	}
	...
	function istartswith($columnList,$wordList,$not=false){
		/*** unit("database.QTest");  */
		return Criterion::pattern($columnList,$wordList,$not,true,"w*");
	}
	 ...
	 * @return Criteria
	 */
	function notiStartswith($columnList,$wordList){
		/*** unit("database.QTest");  */
		return Criterion::istartswith($columnList,$wordList,true);
	}
	 ...
	 * @return Criteria
	 */
	function notEndswith($columnList,$wordList){
		/*** unit("database.QTest");  */
		return Criterion::endswith($columnList,$wordList,true);
	}
	 ...
	 * @return Criteria
	 */
	function notiEndswith($columnList,$wordList){
		/*** unit("database.QTest");  */
		return Criterion::iendswith($columnList,$wordList,true);
	}
	...
	function contains($columnList,$wordList,$not=false){
		/*** unit("database.QTest");  */
		return Criterion::pattern($columnList,$wordList,$not,false,"*");
	}
	 ...
	 * @return Criteria
	 */
	function notContains($columnList,$wordList){
		/*** unit("database.QTest");  */
		return Criterion::contains($columnList,$wordList,true);
	}
	...
	function icontains($columnList,$wordList,$not=false){
		/*** unit("database.QTest");  */
		return Criterion::pattern($columnList,$wordList,$not,true,"*");
	}
	 ...
	 * @return Criteria
	 */
	function notiContains($columnList,$wordList){
		/*** unit("database.QTest");  */
		return Criterion::icontains($columnList,$wordList,true);
	}
