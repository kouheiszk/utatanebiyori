...
class Url{
	...
	function parse($src,$remotePath){
		...
		if(!empty($remotePath)){
			...
			$pathArray = explode("/",$urlList["path"]);
	...
	function parseAbsolute($baseUrl,$targetUrl){
		/***
			...
			eq("http://www.rhaco.org/doc/ja/action.html/index.html",Url::parseAbsolute('http://www.rhaco.org/doc/ja/action.html', 'index.html'));
			eq("http://www.rhaco.org/doc/ja/sample.cgi?query=key/?param=test",Url::parseAbsolute('http://www.rhaco.org/doc/ja/sample.cgi?query=key', '?param=test'));
			eq("http://www.rhaco.org/doc/index.html",Url::parseAbsolute('http://www.rhaco.org/doc/ja/action.html', '../../index.html'));
			eq("http://www.rhaco.org/?param=test",Url::parseAbsolute('http://www.rhaco.org/doc/ja/sample.cgi?query=key', '../../../?param=test'));
		 */
