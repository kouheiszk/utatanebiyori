...
$language_considering_setting_level = 0;
...
defined('DATA_DIR')       or define('DATA_DIR',      DATA_HOME . '../data/wiki/wiki/'     ); // Latest wiki texts
defined('DIFF_DIR')       or define('DIFF_DIR',      DATA_HOME . '../data/wiki/diff/'     ); // Latest diffs
defined('BACKUP_DIR')     or define('BACKUP_DIR',    DATA_HOME . '../data/wiki/backup/'   ); // Backups
defined('CACHE_DIR')      or define('CACHE_DIR',     DATA_HOME . '../data/wiki/cache/'    ); // Some sort of caches
defined('UPLOAD_DIR')     or define('UPLOAD_DIR',    DATA_HOME . '../data/wiki/attach/'   ); // Attached files and logs
defined('COUNTER_DIR')    or define('COUNTER_DIR',   DATA_HOME . '../data/wiki/counter/'  ); // Counter plugin's counts
defined('TRACKBACK_DIR')  or define('TRACKBACK_DIR', DATA_HOME . '../data/wiki/trackback/'); // TrackBack logs
defined('REFERER_DIR')    or define('REFERER_DIR',   DATA_HOME . '../data/wiki/trackback/'); // Referer logs
defined('LOG_DIR')        or define('LOG_DIR',       DATA_HOME . '../data/wiki/log/'      ); // Logging file
...
defined('IMAGE_DIR')      or define('IMAGE_DIR', WWW_HOME . 'img/');	// Static image files

// for Fancy URL
defined('SKIN_URI')       or define('SKIN_URI',  ROOT_URI . 'skin/');	// CSSs(*.css) and JavaScripts(*.js) are needed at
									// ./SKIN_URI from index.php.
defined('IMAGE_URI')      or define('IMAGE_URI', ROOT_URI . 'img/');	// Keep this directory shown via web browsers like
...
$script = 'http://utatanebiyori.uzusionet.com/wiki2/';
...
// Default page name
$defaultpage  = '夜C＠wiki';     // Top / Default page
$whatsnew     = '最終更新日時'; // Modified page list
$whatsdeleted = '削除一覧'; // Removeed page list
...
//検索エンジンのロボットから逃げる
$nofollow = 1; // 1 = Try hiding from search engines
...
$rss_max = 15;
// Description
$rss_description = '夜C@wiki RecentChanges';
...
$notify_to   = 'kouhei.szk@gmail.com';	// To:
$notify_from = 'utatanebiyori@uzusionet.com';	// From:

// Subject: ($page = Page name wll be replaced)
$notify_subject = '[夜C@Wiki] $page';
...
$open_uri_in_new_window_servername = array(
      'http://utatanebiyori.uzusionet.com/',
      'http://utatanebiyori.uzusionet.com/bbs/',
      'http://utatanebiyori.uzusionet.com/upload/',
);
// URIの種類によって開く動作を設定。
