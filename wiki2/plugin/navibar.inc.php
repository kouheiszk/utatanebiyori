...
//			}
	...
	if ( $is_read ){
		$navi_search_start='<form action="/wiki2/?cmd=search" method="post">';
		$navi_search_end=
'<!-- Serach -->
&nbsp;&nbsp;<span id="search">
<input type="hidden" name="cmd" value="search" />
<input type="text" name="word" size="21" value="" tabindex="10" id="keyword" />
<input type="hidden" name="type" value="AND" tabindex="20" />
<input type="submit" value="検索" id="go-search" tabindex="30" /></span>
</form>';
	} else {
		$navi_search_start='';
		$navi_search_end='';
	...
	return '<div id="navigator">' . $navi_search_start . $line . $navi_search_end . '</div>';
}
