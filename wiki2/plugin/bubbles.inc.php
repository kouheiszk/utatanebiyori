...
function plugin_bubbles_convert()
{
  ...
  if ($bubbles === FALSE) {
    global $head_tags;
    $head_tags[] = ' <link rel="stylesheet" href="' . SKIN_URI . 'css/bubbles.css" type="text/css" media="screen" charset="utf-8" />';
    $head_tags[] = ' <script type="text/javascript" charset="utf-8" src="' . SKIN_URI . 'js/bubbles.js"></script>';
    $bubbles = TRUE;
  }
