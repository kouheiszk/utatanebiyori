...
EOD;
	...
	echo <<<EOD
 <link rel="stylesheet" href="{$SKIN_URI}css/default.css" type="text/css" media="screen" charset="$css_charset" />
 <link rel="stylesheet" href="{$SKIN_URI}css/print.css" type="text/css" media="print" charset="$css_charset" />
...
EOD;
 ...
 <script type="text/javascript" src="{$SKIN_URI}js/default.js"></script>

EOD;

	if (! $use_local_time) {
		echo <<<EOD
 <script type="text/javascript" src="{$SKIN_URI}js/tzCalculation_LocalTimeZone.js"></script>
