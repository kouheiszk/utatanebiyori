...
// Separetor / of / topic / path -> default : &gt;
...
function plugin_topicpath_inline()
{
	...
	if (($title == $defaultpage) || ($vars["page"] == $defaultpage)){
		return '<span class="small">Top</span>';
	} else {
		return '<span class="small">' . join(PLUGIN_TOPICPATH_TOP_SEPARATOR, array_reverse($topic_path)) . "</span>";
	}
}
?>
