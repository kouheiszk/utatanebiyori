...
//$css[] = file_get_contents('css/pukiwiki.css');
//$lastmodtime = max($lastmodtime, filemtime('css/pukiwiki.css'));
$css[] = file_get_contents('css/plus.css');
$lastmodtime = max($lastmodtime, filemtime('css/plus.css'));
...
echo join("\n\n", $css) . "\n\n";
echo '@media print {'."\n";
echo file_get_contents('css/print.css');
echo '}';
?>