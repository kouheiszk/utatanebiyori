...
//
// $Id: navibar2.inc.php,v 0.1.18 2008/06/25 01:50:00 upk Exp $
//
function plugin_navibar2_convert()
{
	...
	return do_plugin_convert('navibar','top,|,new,edit,upload,diff,reload,|,list,search,recent') . $hr;
}
...
{$menublkstr}
<script type="text/javascript" src="{$skin_uri}js/navibar.js"></script>
